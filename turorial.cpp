...
void Tutorial_Draw(void)
{
	...
	//タイトル画面で表示する画像
	Sprite_Draw(TEXTURE_INDEX_TITLE_LOGO,    SCREEN_WIDTH * 0.5  - TITLE_LOGO_WIDTH * TITLE_LOGO_SCALE * 0.5 ,SCREEN_HEIGHT * 0.25 - TITLE_LOGO_HEIGHT * TITLE_LOGO_SCALE * 0.5,0, 0, Texture_GetWidth(TEXTURE_INDEX_TITLE_LOGO), Texture_GetHeight(TEXTURE_INDEX_TITLE_LOGO),0, 0, TITLE_LOGO_SCALE , TITLE_LOGO_SCALE,0);
	Sprite_Draw(TEXTURE_INDEX_TITLE_OPTION,  SCREEN_WIDTH * 0.75 - WOOD_BILL_WIDTH  * WOOD_BILL_SCALE  * 0.5 ,SCREEN_HEIGHT * 0.5											   ,0, 0, Texture_GetWidth(TEXTURE_INDEX_WOOD_BILL),  Texture_GetHeight(TEXTURE_INDEX_WOOD_BILL), 0, 0, WOOD_BILL_SCALE,   WOOD_BILL_SCALE, 0);
	Sprite_Draw(TEXTURE_INDEX_TITLE_START,   SCREEN_WIDTH * 0.5  - WOOD_BILL_WIDTH  * WOOD_BILL_SCALE  * 0.5 ,SCREEN_HEIGHT * 0.5											   ,0, 0, Texture_GetWidth(TEXTURE_INDEX_WOOD_BILL),  Texture_GetHeight(TEXTURE_INDEX_WOOD_BILL), 0, 0, WOOD_BILL_SCALE,   WOOD_BILL_SCALE, 0);
	Sprite_Draw(TEXTURE_INDEX_TITLE_RANKING, SCREEN_WIDTH * 0.25 - WOOD_BILL_WIDTH  * WOOD_BILL_SCALE  * 0.5 ,SCREEN_HEIGHT * 0.5											   ,0, 0, Texture_GetWidth(TEXTURE_INDEX_WOOD_BILL),  Texture_GetHeight(TEXTURE_INDEX_WOOD_BILL), 0, 0, WOOD_BILL_SCALE,   WOOD_BILL_SCALE,0);
	PlayerAction_Draw();
}